...
def winner_takes_all(isbn_claimants, dest_cur):
    ...
    for claimant in isbn_claimants[1:]:
        ...
        logger.info(
            "{} had {} inserts for content_title_id".format(
                winner_id, dest_cur.rowcount
            )
        )
        ...
        logger.info(
            "{} had {} inserts for book_title_id".format(
                winner_id, dest_cur.rowcount
            )
        )
        ...
        logger.info(
            "{} had {} inserts for isbns".format(winner_id, dest_cur.rowcount)
        )
        ...
        logger.info(
            "{} had {} inserts for translations".format(
                winner_id, dest_cur.rowcount
            )
        )
        ...
        logger.info(
            "{} had {} inserts for more_images".format(
                winner_id, dest_cur.rowcount
            )
        )
        ...
        if claimant_cover_image:
            ...
            logger.info(
                "{} had {} inserts for cover image".format(
                    winner_id, dest_cur.rowcount
                )
            )
        ...
        logger.info(
            "{} deleted {}. {} rows affected".format(
                winner_id, claimant_id, dest_cur.rowcount
            )
        )
